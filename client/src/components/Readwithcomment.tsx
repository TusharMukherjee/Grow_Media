      ...
      <div className='sticky flex flex-col items-center'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <div className='w-80 my-2 rounded-md bg-white flex flex-col justify-center'>
                    ...
                    {/* reply cmnt */}
                    <div className='items-center flex flex-row ml-8'>
                        <div className='items-center  rounded-full h-5 w-5 bg-stone-700'></div>
                        <div className='items-center ml-2'>
                            <h1 className='items-center  text-base'>Tushar Mukherjee</h1>
                        </div>
                    </div>
                    <div className='pb-4'>
