          ...
          return (
            <Link to={`/profile/${el.user_id}`} key={index}>
              <div className='grid grid-cols-5'>
                <div className='col-start-2 col-span-3 mb-6 rounded-lg border-[0.5px] bg-white shadow-md hover:shadow-teal-200'>
                <div className='grid grid-cols-8 h-32'>
                {
                    (el.profile_img !== null)?
                    <img src={`https://res.cloudinary.com/dmtfoyuuq/image/upload/v1652613376/${el.profile_img}`} alt={el.profile_img} className='col-span-1 rounded-full h-16 w-16 ml-10 place-self-center'/>
                    :
                    <img src={`https://res.cloudinary.com/dmtfoyuuq/image/upload/v1656086069/e0gy9inebvobnauo1um2.gif`} alt="Default img (Grow_Media)" className='col-span-1 rounded-full h-16 w-16 ml-10 place-self-center'/>
                }
