...
const Followingspost:React.FC = () => {
  return (
<>
      <div className='bg-white grid grid-cols-8 items-center'>
            <div className='bg-white col-start-2 col-span-6 grid grid-cols-5 grid-rows-6 h-52 mb-8 border rounded-md hover:drop-shadow'>
