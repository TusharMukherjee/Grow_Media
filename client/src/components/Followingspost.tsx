                ...
                data?.followingblogs?.map((el) => {
                    return (
                        ...
                        <div className='bg-white grid grid-cols-12 sm:grid-cols-8 items-center pt-6 sm:pt-8' key={Number(el.blog_id)}>
                            <Link to={`/read/${el.blog_id}`} className='bg-white col-start-2 sm:col-start-2 sm:col-span-6 col-span-10 grid grid-cols-5 grid-rows-6 h-48 sm:h-52 mb-6 sm:mb-8 border rounded-md hover:drop-shadow' >
