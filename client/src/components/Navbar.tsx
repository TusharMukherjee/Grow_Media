            ...
            <div className=' flex flex-row justify-between mx-5 w-full'>
              ...
              <div className='flex justify-end '>
                <div className='flex flex-row gap-10 '>
                  ...
                  <div  className={` cursor-pointer font-semibold text-white ${mobile?"visible":"hidden"} `}>
                    {
                      toggleSide?
                      <svg onClick={() => {dispatchJwt(toggleSidedis(false))}} xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
                      </svg>
                      :
                      <svg onClick={() => {dispatchJwt(toggleSidedis(true))}} xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
