        ...
        <div className=' flex justify-center items-center mx-auto grow'>
            <div className=' flex flex-row justify-between mx-10 w-full'>
              ...
              <div className=' bg-blue-500 flex flex-row border-[1px] border-teal-900'>
                  <input type="text" placeholder='Search' className=' text-white bg-teal-800 pl-3 outline-0'/>
                  <button className='w-8 bg-teal-700 p-[4px]'>
              ...
              <div className='flex justify-end'>
                <div className='flex flex-row gap-10 '>
                  ...
                  <NavLink to={`/profile/${selector?.verifyjwtFunc?.user_id}`} style={navLinkStyle} className=' font-semibold text-white '>
